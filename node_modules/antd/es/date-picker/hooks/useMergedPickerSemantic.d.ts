...
declare const useMergedPickerSemantic: <P extends AnyObject = AnyObject>(pickerType: "timePicker" | "datePicker", classNames?: P["classNames"], styles?: P["styles"], popupClassName?: string, popupStyle?: React.CSSProperties, mergedProps?: P) => readonly [Required<import("../../_util/hooks/useMergeSemantic/semanticType").RemoveClassNamesString<NonNullable<P["classNames"]>>> & {
